        ...
        <div className="p-4 sm:p-8 min-h-screen ">
            ...
            <div className="bg-white rounded-2xl shadow border border-gray-100 p-5 mb-6">
                ...
                <div className="lg:col-span-1 mt-auto">
                    ...
                    disabled={loading}
                    className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl text-sm font-bold shadow transition ${
                        loading
                    ...
                    {loading ? 'Chargement…' : 'Recherche par date'}
                    </button>
                </div>
                </div>
                ...
                {/* ── Ligne 2 : Filtres par classe ── */}
                <div className="flex flex-wrap items-center gap-2">

                {/* Label */}
                <div className="flex items-center gap-1.5 mr-1 flex-shrink-0">
                    <FaSchool className="text-indigo-400" size={12} />
